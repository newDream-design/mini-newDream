...
Page({
    ...
    onLoad: function(options) {
        ...
        that.setData({
            ...
            userGender: Number(options.userGender == undefined ? 1 : options.userGender),
            userHeight: Number(options.userHeight == undefined ? 175 : options.userHeight),
            userWeight: Number(options.userWeight == undefined ? 70 : options.userWeight),
			userInfo: options.userName == undefined ? "未知用户" : options.userName
        })
        wx.hideLoading();
        wx.showLoading({
            title: '拼命加载中...',
